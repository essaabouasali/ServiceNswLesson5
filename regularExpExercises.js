...
// Q1
function validEmail(sentences) {
    return EMAIL_REGEX.test(sentences);
}

//console.log(validEmail("this is my Email : essa.abouasali@outlook"));

// Q2

function findindex(sentences) {
    let valid = URL_REGEX.test(sentences);
    if (valid) {
        let url = sentences.search(URL_REGEX);
        return url;
    }
    return -1;
}
console.log(findindex("this is my url : https://www.google.com"));
